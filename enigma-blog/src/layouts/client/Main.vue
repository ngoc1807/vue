...
//   hideSearchDropdown,
// } from "./index";
import { nestedMenu, linkTo } from "@/layouts/client";
...
const topMenu = computed(() => nestedMenu(clientMenuStore.menu, route));
...
onMounted(() => {
  ...
  // console.log("formattedMenu.value ", formattedMenu.value);
});
</script>
